...
public class pomodoro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workTime = findViewById(R.id.workingTimerOption);
        breakTimer = findViewById(R.id.breakTimerOption);
    ...
    protected void onStart() {
        ...
        workTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent workIntent = new Intent(pomodoro.this, SetTime.class);
        ...
        breakTimer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent breakIntent = new Intent(pomodoro.this, SetTime.class);
